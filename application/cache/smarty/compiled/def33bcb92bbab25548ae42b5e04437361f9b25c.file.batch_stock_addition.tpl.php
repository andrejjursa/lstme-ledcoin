<?php /* Smarty version Smarty-3.1.17, created on 2014-07-27 15:09:41
...
content_53d4fa155cfbb1_29455555($_smarty_tpl);
...
content_53d4fa1561fd71_38973029($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
...
content_53d4fa15677944_46307074($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
...
content_53d4fa15817618_57255327($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
...
<?php if ($_valid && !is_callable('content_53d4fa155cfbb1_29455555')) {function content_53d4fa155cfbb1_29455555($_smarty_tpl) {?><div class="ui-panel-inner">
...
<?php if ($_valid && !is_callable('content_53d4fa1561fd71_38973029')) {function content_53d4fa1561fd71_38973029($_smarty_tpl) {?><?php $_smarty_tpl->tpl_vars['flash_messages'] = new Smarty_variable(get_flash_messages(), null, 0);?>
...
<?php if ($_valid && !is_callable('content_53d4fa15677944_46307074')) {function content_53d4fa15677944_46307074($_smarty_tpl) {?><?php if (isset($_smarty_tpl->tpl_vars['form']->value['fields'])&&isset($_smarty_tpl->tpl_vars['form']->value['arangement'])&&is_array($_smarty_tpl->tpl_vars['form']->value['fields'])&&is_array($_smarty_tpl->tpl_vars['form']->value['arangement'])) {?>
...
content_53d4fa156b49d5_91540800($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
...
content_53d4fa1573df11_02044436($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
...
content_53d4fa157a4f07_03928586($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
...
<?php if ($_valid && !is_callable('content_53d4fa156b49d5_91540800')) {function content_53d4fa156b49d5_91540800($_smarty_tpl) {?><?php if (!is_callable('smarty_function_form_value')) include 'C:\\xampp\\htdocs\\lstme_strojak\\application\\third_party\\Smarty\\plugins\\function.form_value.php';
...
<?php if ($_valid && !is_callable('content_53d4fa1573df11_02044436')) {function content_53d4fa1573df11_02044436($_smarty_tpl) {?><?php if (!is_callable('smarty_function_form_value')) include 'C:\\xampp\\htdocs\\lstme_strojak\\application\\third_party\\Smarty\\plugins\\function.form_value.php';
...
<?php if ($_valid && !is_callable('content_53d4fa157a4f07_03928586')) {function content_53d4fa157a4f07_03928586($_smarty_tpl) {?><?php if (!is_callable('smarty_function_form_value')) include 'C:\\xampp\\htdocs\\lstme_strojak\\application\\third_party\\Smarty\\plugins\\function.form_value.php';
if (!is_callable('smarty_function_html_options')) include 'C:\\xampp\\htdocs\\lstme_strojak\\application\\third_party\\Smarty\\plugins\\function.html_options.php';
?><div class="ui-field-contain">
    <label <?php if ($_smarty_tpl->tpl_vars['form_element']->value['id']) {?>for="<?php echo $_smarty_tpl->tpl_vars['form_element']->value['id'];?>
"<?php }?>><?php echo (($tmp = @$_smarty_tpl->tpl_vars['form_element']->value['label'])===null||$tmp==='' ? 'Textový vstup' : $tmp);?>
...
<?php if ($_valid && !is_callable('content_53d4fa15817618_57255327')) {function content_53d4fa15817618_57255327($_smarty_tpl) {?><div data-role="popup" id="logoutDialog" data-overlay-theme="d" data-theme="d" data-dismissible="false" style="max-width:400px;">
