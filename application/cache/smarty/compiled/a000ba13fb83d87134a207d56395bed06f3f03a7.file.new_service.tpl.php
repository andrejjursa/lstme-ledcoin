<?php /* Smarty version Smarty-3.1.17, created on 2014-07-26 15:39:12
...
content_53d3af80aa3b17_83182722($_smarty_tpl);
...
content_53d3af80af3cd0_71760493($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
...
content_53d3af80b4b8a2_87924908($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
...
content_53d3af80ce3b66_05864763($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
...
<?php if ($_valid && !is_callable('content_53d3af80aa3b17_83182722')) {function content_53d3af80aa3b17_83182722($_smarty_tpl) {?><div class="ui-panel-inner">
...
<?php if ($_valid && !is_callable('content_53d3af80af3cd0_71760493')) {function content_53d3af80af3cd0_71760493($_smarty_tpl) {?><?php $_smarty_tpl->tpl_vars['flash_messages'] = new Smarty_variable(get_flash_messages(), null, 0);?>
...
<?php if ($_valid && !is_callable('content_53d3af80b4b8a2_87924908')) {function content_53d3af80b4b8a2_87924908($_smarty_tpl) {?><?php if (isset($_smarty_tpl->tpl_vars['form']->value['fields'])&&isset($_smarty_tpl->tpl_vars['form']->value['arangement'])&&is_array($_smarty_tpl->tpl_vars['form']->value['fields'])&&is_array($_smarty_tpl->tpl_vars['form']->value['arangement'])) {?>
...
content_53d3af80b88933_99133230($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
...
content_53d3af80c11e75_20377883($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
...
content_53d3af80c75160_94205704($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
...
<?php if ($_valid && !is_callable('content_53d3af80b88933_99133230')) {function content_53d3af80b88933_99133230($_smarty_tpl) {?><?php if (!is_callable('smarty_function_form_value')) include 'C:\\xampp\\htdocs\\lstme_strojak\\application\\third_party\\Smarty\\plugins\\function.form_value.php';
...
<?php if ($_valid && !is_callable('content_53d3af80c11e75_20377883')) {function content_53d3af80c11e75_20377883($_smarty_tpl) {?><?php if (!is_callable('smarty_function_form_value')) include 'C:\\xampp\\htdocs\\lstme_strojak\\application\\third_party\\Smarty\\plugins\\function.form_value.php';
...
<?php if ($_valid && !is_callable('content_53d3af80c75160_94205704')) {function content_53d3af80c75160_94205704($_smarty_tpl) {?><?php if (!is_callable('smarty_function_form_value')) include 'C:\\xampp\\htdocs\\lstme_strojak\\application\\third_party\\Smarty\\plugins\\function.form_value.php';
if (!is_callable('smarty_function_html_options')) include 'C:\\xampp\\htdocs\\lstme_strojak\\application\\third_party\\Smarty\\plugins\\function.html_options.php';
?><div class="ui-field-contain">
    <label <?php if ($_smarty_tpl->tpl_vars['form_element']->value['id']) {?>for="<?php echo $_smarty_tpl->tpl_vars['form_element']->value['id'];?>
"<?php }?>><?php echo (($tmp = @$_smarty_tpl->tpl_vars['form_element']->value['label'])===null||$tmp==='' ? 'Textový vstup' : $tmp);?>
...
<?php if ($_valid && !is_callable('content_53d3af80ce3b66_05864763')) {function content_53d3af80ce3b66_05864763($_smarty_tpl) {?><div data-role="popup" id="logoutDialog" data-overlay-theme="d" data-theme="d" data-dismissible="false" style="max-width:400px;">
