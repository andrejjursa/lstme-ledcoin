<?php /* Smarty version Smarty-3.1.17, created on 2014-07-26 12:33:33
         compiled from "application\views\web\controllers\products\edit_product_quantity.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1501553d383c176bb80-00769309%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9c7bcaf5c6429841507a464d048473dde4b535c1' => 
    array (
      0 => 'application\\views\\web\\controllers\\products\\edit_product_quantity.tpl',
      1 => 1406370802,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '1501553d383c176bb80-00769309',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.17',
  'unifunc' => 'content_53d383c176f885_75173298',
  'variables' => 
  array (
    'this' => 0,
    'title' => 0,
...
<?php if ($_valid && !is_callable('content_53d383c176f885_75173298')) {function content_53d383c176f885_75173298($_smarty_tpl) {?><!DOCTYPE html><?php $_smarty_tpl->tpl_vars['app_version'] = new Smarty_variable($_smarty_tpl->tpl_vars['this']->value->config->item('app_version'), null, 0);?>
<html lang="sk">
    <head>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('web/partials/navpanel.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '1501553d383c176bb80-00769309');
content_53d383fdcaa7e6_58386346($_smarty_tpl);
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('web/partials/flashmessages.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '1501553d383c176bb80-00769309');
content_53d383fdcfa9a9_05005902($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
/*  End of included template "web/partials/flashmessages.tpl" */?>
                
    <form action="<?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['product']->value->id);?>
<?php $_tmp1=ob_get_clean();?><?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['product_quantity']->value->id);?>
<?php $_tmp2=ob_get_clean();?><?php echo site_url("products/update_product_quantity/".$_tmp1."/".$_tmp2);?>
" method="post" data-ajax="false">
    <?php /*  Call merged included template "web/partials/form.tpl" */
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('web/partials/form.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('form'=>$_smarty_tpl->tpl_vars['form']->value,'source'=>$_smarty_tpl->tpl_vars['product_quantity']->value), 0, '1501553d383c176bb80-00769309');
content_53d383fdd61996_27773105($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('web/partials/logoutDialog.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '1501553d383c176bb80-00769309');
content_53d383fdf01660_69781265($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
...
<?php if ($_valid && !is_callable('content_53d383fdcaa7e6_58386346')) {function content_53d383fdcaa7e6_58386346($_smarty_tpl) {?><div class="ui-panel-inner">
...
<?php if ($_valid && !is_callable('content_53d383fdcfa9a9_05005902')) {function content_53d383fdcfa9a9_05005902($_smarty_tpl) {?><?php $_smarty_tpl->tpl_vars['flash_messages'] = new Smarty_variable(get_flash_messages(), null, 0);?>
...
<?php if ($_valid && !is_callable('content_53d383fdd61996_27773105')) {function content_53d383fdd61996_27773105($_smarty_tpl) {?><?php if (isset($_smarty_tpl->tpl_vars['form']->value['fields'])&&isset($_smarty_tpl->tpl_vars['form']->value['arangement'])&&is_array($_smarty_tpl->tpl_vars['form']->value['fields'])&&is_array($_smarty_tpl->tpl_vars['form']->value['arangement'])) {?>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('web/forms/input.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('form_element'=>$_smarty_tpl->tpl_vars['form_element']->value,'form_source'=>$_smarty_tpl->tpl_vars['source']->value), 0, '1501553d383c176bb80-00769309');
content_53d383fdd9ea27_89431236($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('web/forms/select.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('form_element'=>$_smarty_tpl->tpl_vars['form_element']->value,'form_source'=>$_smarty_tpl->tpl_vars['source']->value), 0, '1501553d383c176bb80-00769309');
content_53d383fde2bc73_29254446($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('web/forms/flipswitch.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('form_element'=>$_smarty_tpl->tpl_vars['form_element']->value,'form_source'=>$_smarty_tpl->tpl_vars['source']->value), 0, '1501553d383c176bb80-00769309');
content_53d383fde92c69_75846252($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
...
<?php if ($_valid && !is_callable('content_53d383fdd9ea27_89431236')) {function content_53d383fdd9ea27_89431236($_smarty_tpl) {?><?php if (!is_callable('smarty_function_form_value')) include 'C:\\xampp\\htdocs\\lstme_strojak\\application\\third_party\\Smarty\\plugins\\function.form_value.php';
...
<?php if ($_valid && !is_callable('content_53d383fde2bc73_29254446')) {function content_53d383fde2bc73_29254446($_smarty_tpl) {?><?php if (!is_callable('smarty_function_form_value')) include 'C:\\xampp\\htdocs\\lstme_strojak\\application\\third_party\\Smarty\\plugins\\function.form_value.php';
...
<?php $_tmp3=ob_get_clean();?><?php echo smarty_function_html_options(array('options'=>$_smarty_tpl->tpl_vars['form_element']->value['values'],'selected'=>$_tmp3),$_smarty_tpl);?>
...
<?php if ($_valid && !is_callable('content_53d383fde92c69_75846252')) {function content_53d383fde92c69_75846252($_smarty_tpl) {?><?php if (!is_callable('smarty_function_form_value')) include 'C:\\xampp\\htdocs\\lstme_strojak\\application\\third_party\\Smarty\\plugins\\function.form_value.php';
if (!is_callable('smarty_function_html_options')) include 'C:\\xampp\\htdocs\\lstme_strojak\\application\\third_party\\Smarty\\plugins\\function.html_options.php';
?><div class="ui-field-contain">
    <label <?php if ($_smarty_tpl->tpl_vars['form_element']->value['id']) {?>for="<?php echo $_smarty_tpl->tpl_vars['form_element']->value['id'];?>
"<?php }?>><?php echo (($tmp = @$_smarty_tpl->tpl_vars['form_element']->value['label'])===null||$tmp==='' ? 'Textový vstup' : $tmp);?>
...
"<?php }?> data-role="slider" <?php if (form_error($_smarty_tpl->tpl_vars['form_element']->value['name'])!='') {?>data-theme="b"<?php }?>>
        ...
        <?php ob_start();?><?php echo smarty_function_form_value(array('default'=>(($tmp = @$_smarty_tpl->tpl_vars['form_element']->value['default'])===null||$tmp==='' ? '' : $tmp),'source'=>(($tmp = @$_smarty_tpl->tpl_vars['form_source']->value)===null||$tmp==='' ? '' : $tmp),'name'=>(($tmp = @$_smarty_tpl->tpl_vars['form_element']->value['name'])===null||$tmp==='' ? '' : $tmp),'property'=>(($tmp = @$_smarty_tpl->tpl_vars['form_element']->value['object_property'])===null||$tmp==='' ? '' : $tmp)),$_smarty_tpl);?>
<?php $_tmp4=ob_get_clean();?><?php echo smarty_function_html_options(array('options'=>$_smarty_tpl->tpl_vars['values']->value,'selected'=>$_tmp4),$_smarty_tpl);?>
...
<?php if ($_valid && !is_callable('content_53d383fdf01660_69781265')) {function content_53d383fdf01660_69781265($_smarty_tpl) {?><div data-role="popup" id="logoutDialog" data-overlay-theme="d" data-theme="d" data-dismissible="false" style="max-width:400px;">
