<?php /* Smarty version Smarty-3.1.17, created on 2014-07-28 18:27:20
...
content_53d679e85f9b13_58287167($_smarty_tpl);
...
content_53d679e8649cd1_78089909($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
...
content_53d679e86a18a0_51805483($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
...
content_53d679e88bf3a0_19368745($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
...
<?php if ($_valid && !is_callable('content_53d679e85f9b13_58287167')) {function content_53d679e85f9b13_58287167($_smarty_tpl) {?><div class="ui-panel-inner">
...
<?php if ($_valid && !is_callable('content_53d679e8649cd1_78089909')) {function content_53d679e8649cd1_78089909($_smarty_tpl) {?><?php $_smarty_tpl->tpl_vars['flash_messages'] = new Smarty_variable(get_flash_messages(), null, 0);?>
...
<?php if ($_valid && !is_callable('content_53d679e86a18a0_51805483')) {function content_53d679e86a18a0_51805483($_smarty_tpl) {?><?php if (isset($_smarty_tpl->tpl_vars['form']->value['fields'])&&isset($_smarty_tpl->tpl_vars['form']->value['arangement'])&&is_array($_smarty_tpl->tpl_vars['form']->value['fields'])&&is_array($_smarty_tpl->tpl_vars['form']->value['arangement'])) {?>
...
content_53d679e86de938_60658013($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
...
content_53d679e8764176_58356336($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
...
content_53d679e87cb162_08587790($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
...
content_53d679e8835e56_97905760($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
...
content_53d679e8899148_35948555($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
...
<?php if ($_valid && !is_callable('content_53d679e86de938_60658013')) {function content_53d679e86de938_60658013($_smarty_tpl) {?><?php if (!is_callable('smarty_function_form_value')) include 'C:\\xampp\\htdocs\\lstme_strojak\\application\\third_party\\Smarty\\plugins\\function.form_value.php';
...
<?php if ($_valid && !is_callable('content_53d679e8764176_58356336')) {function content_53d679e8764176_58356336($_smarty_tpl) {?><?php if (!is_callable('smarty_function_form_value')) include 'C:\\xampp\\htdocs\\lstme_strojak\\application\\third_party\\Smarty\\plugins\\function.form_value.php';
...
<?php if ($_valid && !is_callable('content_53d679e87cb162_08587790')) {function content_53d679e87cb162_08587790($_smarty_tpl) {?><?php if (!is_callable('smarty_function_form_value')) include 'C:\\xampp\\htdocs\\lstme_strojak\\application\\third_party\\Smarty\\plugins\\function.form_value.php';
if (!is_callable('smarty_function_html_options')) include 'C:\\xampp\\htdocs\\lstme_strojak\\application\\third_party\\Smarty\\plugins\\function.html_options.php';
?><div class="ui-field-contain">
    <label <?php if ($_smarty_tpl->tpl_vars['form_element']->value['id']) {?>for="<?php echo $_smarty_tpl->tpl_vars['form_element']->value['id'];?>
"<?php }?>><?php echo (($tmp = @$_smarty_tpl->tpl_vars['form_element']->value['label'])===null||$tmp==='' ? 'Textový vstup' : $tmp);?>
...
<?php if ($_valid && !is_callable('content_53d679e8835e56_97905760')) {function content_53d679e8835e56_97905760($_smarty_tpl) {?><?php if (!is_callable('smarty_function_form_value')) include 'C:\\xampp\\htdocs\\lstme_strojak\\application\\third_party\\Smarty\\plugins\\function.form_value.php';
...
<?php if ($_valid && !is_callable('content_53d679e8899148_35948555')) {function content_53d679e8899148_35948555($_smarty_tpl) {?><?php if (isset($_smarty_tpl->tpl_vars['form_element']->value['text'])&&trim($_smarty_tpl->tpl_vars['form_element']->value['text'])!='') {?>
...
<?php if ($_valid && !is_callable('content_53d679e88bf3a0_19368745')) {function content_53d679e88bf3a0_19368745($_smarty_tpl) {?><div data-role="popup" id="logoutDialog" data-overlay-theme="d" data-theme="d" data-dismissible="false" style="max-width:400px;">
