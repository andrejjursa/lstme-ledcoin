<?php /* Smarty version Smarty-3.1.17, created on 2014-07-27 15:41:01
         compiled from "application\views\web\controllers\services\overview.tpl" */ ?>
<?php /*%%SmartyHeaderCode:148753d500a9cfe6a7-27787069%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9d0c7d28be587c7f463ae3bef0d3aa4603fa8e86' => 
    array (
      0 => 'application\\views\\web\\controllers\\services\\overview.tpl',
      1 => 1406468447,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '148753d500a9cfe6a7-27787069',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.17',
  'unifunc' => 'content_53d500a9eea833_29816871',
  'variables' => 
  array (
    'this' => 0,
    'title' => 0,
...
<?php if ($_valid && !is_callable('content_53d500a9eea833_29816871')) {function content_53d500a9eea833_29816871($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'C:\\xampp\\htdocs\\lstme_strojak\\application\\third_party\\Smarty\\plugins\\modifier.date_format.php';
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('web/partials/navpanel.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '148753d500a9cfe6a7-27787069');
content_53d5016e02dc62_74297801($_smarty_tpl);
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('web/partials/flashmessages.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '148753d500a9cfe6a7-27787069');
content_53d5016e07de26_13977492($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
/*  End of included template "web/partials/flashmessages.tpl" */?>
                
    <div class="ui-body ui-body-c ui-corner-all">
        <?php if ($_smarty_tpl->tpl_vars['service_usages']->value->exists()) {?>
        <table data-role="table" data-mode="reflow" class="admin_grid_table ui-responsive">
            ...
            <tbody>
                <?php  $_smarty_tpl->tpl_vars['usage'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['usage']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['service_usages']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['usage']->key => $_smarty_tpl->tpl_vars['usage']->value) {
$_smarty_tpl->tpl_vars['usage']->_loop = true;
?>
                <tr>
                    <td><?php echo $_smarty_tpl->tpl_vars['usage']->value->id;?>
</td>
                    <td><?php echo (($tmp = @smarty_modifier_date_format($_smarty_tpl->tpl_vars['usage']->value->created,'%d. %m. %Y'))===null||$tmp==='' ? 'neznámy' : $tmp);?>
</td>
                    <td><?php /*  Call merged included template "web/partials/minutes_inflection.tpl" */
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('web/partials/minutes_inflection.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('minutes'=>intval($_smarty_tpl->tpl_vars['usage']->value->quantity)), 0, '148753d500a9cfe6a7-27787069');
content_53d5016e0f0534_95605981($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
/*  End of included template "web/partials/minutes_inflection.tpl" */?></td>
                    <td><?php echo $_smarty_tpl->tpl_vars['usage']->value->operation_person_name;?>
 <?php echo $_smarty_tpl->tpl_vars['usage']->value->operation_person_surname;?>
</td>
                    <td><?php echo $_smarty_tpl->tpl_vars['usage']->value->operation_admin_name;?>
 <?php echo $_smarty_tpl->tpl_vars['usage']->value->operation_admin_surname;?>
</td>
                    <td><?php echo (($tmp = @$_smarty_tpl->tpl_vars['usage']->value->operation_workplace_title)===null||$tmp==='' ? '---' : $tmp);?>
</td>
                    <td><?php /*  Call merged included template "web/partials/minutes_inflection.tpl" */
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('web/partials/minutes_inflection.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('minutes'=>intval($_smarty_tpl->tpl_vars['usage']->value->price)), 0, '148753d500a9cfe6a7-27787069');
content_53d5016e0f0534_95605981($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
/*  End of included template "web/partials/minutes_inflection.tpl" */?></td>
                </tr>
        ...
        <?php } else { ?>
            Momentálne nie sú k dispozícii žiadne prehľadové informácie k službe <strong><?php echo $_smarty_tpl->tpl_vars['service']->value->title;?>
</strong>.
        <?php }?>
    </div>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('web/partials/logoutDialog.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '148753d500a9cfe6a7-27787069');
content_53d5016e125bb1_15467767($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
/*  End of included template "web/partials/logoutDialog.tpl" */?>
        </div>
    </body>
</html><?php }} ?>
<?php /* Smarty version Smarty-3.1.17, created on 2014-07-27 15:41:02
         compiled from "application\views\web\partials\navpanel.tpl" */ ?>
<?php if ($_valid && !is_callable('content_53d5016e02dc62_74297801')) {function content_53d5016e02dc62_74297801($_smarty_tpl) {?><div class="ui-panel-inner">
...
<?php if ($_valid && !is_callable('content_53d5016e07de26_13977492')) {function content_53d5016e07de26_13977492($_smarty_tpl) {?><?php $_smarty_tpl->tpl_vars['flash_messages'] = new Smarty_variable(get_flash_messages(), null, 0);?>
...
<?php if ($_valid && !is_callable('content_53d5016e0f0534_95605981')) {function content_53d5016e0f0534_95605981($_smarty_tpl) {?><?php echo $_smarty_tpl->tpl_vars['minutes']->value;?>
...
<?php if ($_valid && !is_callable('content_53d5016e125bb1_15467767')) {function content_53d5016e125bb1_15467767($_smarty_tpl) {?><div data-role="popup" id="logoutDialog" data-overlay-theme="d" data-theme="d" data-dismissible="false" style="max-width:400px;">
