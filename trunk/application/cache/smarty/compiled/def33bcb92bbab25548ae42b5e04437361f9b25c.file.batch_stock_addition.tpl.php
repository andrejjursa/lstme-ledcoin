<?php /* Smarty version Smarty-3.1.17, created on 2014-07-29 15:42:21
...
content_53d7a4bd1813e2_48978071($_smarty_tpl);
...
content_53d7a4bd1d9909_08320770($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
...
content_53d7a4bd239984_85658185($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
...
content_53d7a4bd4bee20_93046648($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
...
<?php if ($_valid && !is_callable('content_53d7a4bd1813e2_48978071')) {function content_53d7a4bd1813e2_48978071($_smarty_tpl) {?><div class="ui-panel-inner">
...
<?php if ($_valid && !is_callable('content_53d7a4bd1d9909_08320770')) {function content_53d7a4bd1d9909_08320770($_smarty_tpl) {?><?php $_smarty_tpl->tpl_vars['flash_messages'] = new Smarty_variable(get_flash_messages(), null, 0);?>
...
<?php if ($_valid && !is_callable('content_53d7a4bd239984_85658185')) {function content_53d7a4bd239984_85658185($_smarty_tpl) {?><?php if (isset($_smarty_tpl->tpl_vars['form']->value['fields'])&&isset($_smarty_tpl->tpl_vars['form']->value['arangement'])&&is_array($_smarty_tpl->tpl_vars['form']->value['fields'])&&is_array($_smarty_tpl->tpl_vars['form']->value['arangement'])) {?>
...
content_53d7a4bd27f7e8_00357183($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
...
content_53d7a4bd3321d2_78126859($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
...
content_53d7a4bd39f0b9_47722746($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
...
content_53d7a4bd4123c1_16665708($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
...
content_53d7a4bd483879_34135977($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
...
<?php if ($_valid && !is_callable('content_53d7a4bd27f7e8_00357183')) {function content_53d7a4bd27f7e8_00357183($_smarty_tpl) {?><?php if (!is_callable('smarty_function_form_value')) include 'C:\\xampp\\htdocs\\lstme_strojak\\application\\third_party\\Smarty\\plugins\\function.form_value.php';
...
<?php if ($_valid && !is_callable('content_53d7a4bd3321d2_78126859')) {function content_53d7a4bd3321d2_78126859($_smarty_tpl) {?><?php if (!is_callable('smarty_function_form_value')) include 'C:\\xampp\\htdocs\\lstme_strojak\\application\\third_party\\Smarty\\plugins\\function.form_value.php';
...
<?php if ($_valid && !is_callable('content_53d7a4bd39f0b9_47722746')) {function content_53d7a4bd39f0b9_47722746($_smarty_tpl) {?><?php if (!is_callable('smarty_function_form_value')) include 'C:\\xampp\\htdocs\\lstme_strojak\\application\\third_party\\Smarty\\plugins\\function.form_value.php';
if (!is_callable('smarty_function_html_options')) include 'C:\\xampp\\htdocs\\lstme_strojak\\application\\third_party\\Smarty\\plugins\\function.html_options.php';
?><div class="ui-field-contain">
    <label <?php if ($_smarty_tpl->tpl_vars['form_element']->value['id']) {?>for="<?php echo $_smarty_tpl->tpl_vars['form_element']->value['id'];?>
"<?php }?>><?php echo (($tmp = @$_smarty_tpl->tpl_vars['form_element']->value['label'])===null||$tmp==='' ? 'Textový vstup' : $tmp);?>
...
<?php if ($_valid && !is_callable('content_53d7a4bd4123c1_16665708')) {function content_53d7a4bd4123c1_16665708($_smarty_tpl) {?><?php if (!is_callable('smarty_function_form_value')) include 'C:\\xampp\\htdocs\\lstme_strojak\\application\\third_party\\Smarty\\plugins\\function.form_value.php';
...
<?php if ($_valid && !is_callable('content_53d7a4bd483879_34135977')) {function content_53d7a4bd483879_34135977($_smarty_tpl) {?><?php if (isset($_smarty_tpl->tpl_vars['form_element']->value['text'])&&trim($_smarty_tpl->tpl_vars['form_element']->value['text'])!='') {?>
...
<?php if ($_valid && !is_callable('content_53d7a4bd4bee20_93046648')) {function content_53d7a4bd4bee20_93046648($_smarty_tpl) {?><div data-role="popup" id="logoutDialog" data-overlay-theme="d" data-theme="d" data-dismissible="false" style="max-width:400px;">
