<?php /* Smarty version Smarty-3.1.17, created on 2014-07-26 15:05:39
...
content_53d3a7a3ddbab7_37244429($_smarty_tpl);
...
content_53d3a7a3e1c849_43133333($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('web/partials/minutes_inflection.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('minutes'=>$_smarty_tpl->tpl_vars['product']->value->price), 0, '260053cd3fc8527e28-46686392');
content_53d3a7a3e78127_12700037($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('web/partials/pieces_inflection.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('pieces'=>intval($_tmp1)), 0, '260053cd3fc8527e28-46686392');
content_53d3a7a3e92c61_32641624($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('web/partials/pieces_inflection.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('pieces'=>intval($_smarty_tpl->tpl_vars['product']->value->minus_quantity)), 0, '260053cd3fc8527e28-46686392');
content_53d3a7a3e92c61_32641624($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
/*  End of included template "web/partials/pieces_inflection.tpl" */?></td>
                </tr>
...
content_53d3a7a3eb14a7_70150140($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
...
<?php if ($_valid && !is_callable('content_53d3a7a3ddbab7_37244429')) {function content_53d3a7a3ddbab7_37244429($_smarty_tpl) {?><div class="ui-panel-inner">
...
<?php if ($_valid && !is_callable('content_53d3a7a3e1c849_43133333')) {function content_53d3a7a3e1c849_43133333($_smarty_tpl) {?><?php $_smarty_tpl->tpl_vars['flash_messages'] = new Smarty_variable(get_flash_messages(), null, 0);?>
...
<?php if ($_valid && !is_callable('content_53d3a7a3e78127_12700037')) {function content_53d3a7a3e78127_12700037($_smarty_tpl) {?><?php echo $_smarty_tpl->tpl_vars['minutes']->value;?>
...
<?php if ($_valid && !is_callable('content_53d3a7a3e92c61_32641624')) {function content_53d3a7a3e92c61_32641624($_smarty_tpl) {?><?php echo $_smarty_tpl->tpl_vars['pieces']->value;?>
...
<?php if ($_valid && !is_callable('content_53d3a7a3eb14a7_70150140')) {function content_53d3a7a3eb14a7_70150140($_smarty_tpl) {?><div data-role="popup" id="logoutDialog" data-overlay-theme="d" data-theme="d" data-dismissible="false" style="max-width:400px;">
